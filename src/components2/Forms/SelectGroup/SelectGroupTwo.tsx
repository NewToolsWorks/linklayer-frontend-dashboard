...
interface SelectProps{
  NetworkList:NetworkInterface[]
  CallSelected: (index:number)=>void
  selOption:number
}
const SelectGroupTwo = (props: SelectProps) => {
        ...
        >
          ...
          </option>
          {
            props.NetworkList.map((network,index) => {
              return (<>
                <option value={index} className="text-body dark:text-bodydark">
                  {network.NetName} IP = {network.Ip}
                </option>
              </>)
            })
          }
